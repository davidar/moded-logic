...
nat = rget $ (procedure @'[ 'In ] natI) :& (procedure @'[ 'Out ] natO) :& RNil
  where
    ...
    natO = do
      -- solution: arg1[0,0] arg1[0] arg1[1,2] arg1[1] arg1[] n'[1,1] n[1,0]
      -- cost: 4
      (arg1) <- (do
        arg1 <- pure 0
        pure (arg1)
...
oddNat = rget $ (procedure @'[ 'In ] oddNatI) :& (procedure @'[ 'Out ] oddNatO) :& RNil
  where
    oddNatI = \arg1 -> Logic.once $ do
      -- solution: data0[1,2] n'[1,3] n[1,1]
      -- cost: 3
      () <- (do
        guard $ arg1 == 1
        pure ()
    ...
    oddNatO = do
      -- solution: arg1[0,0] arg1[0] arg1[1,3] arg1[1] arg1[] data0[1,2] n'[1,1] n[1,0]
      -- cost: 4
      (arg1) <- (do
        arg1 <- pure 1
        pure (arg1)
...
span = rget $ (procedure @'[ 'PredMode '[ 'In ], 'In, 'In, 'In ] spanP1IIII) :& (procedure @'[ 'PredMode '[ 'In ], 'In, 'In, 'Out ] spanP1IIIO) :& (procedure @'[ 'PredMode '[ 'In ], 'In, 'Out, 'In ] spanP1IIOI) :& (procedure @'[ 'PredMode '[ 'In ], 'In, 'Out, 'Out ] spanP1IIOO) :& RNil
  where
    spanP1IIII = \arg1 arg2 arg3 arg4 -> Logic.once $ do
      -- solution: p[1,4] x0[1,0] x2[1,3,1,1] x3[1,3,2,2] x[1,1] xs1[1,0] xs4[1,3,2,3] xs[1,2] ys[1,5] yt[1,3,1,1] zs[1,6]
      -- cost: 2
      () <- (do
        guard $ arg2 == []
        guard $ arg3 == []
    ...
    spanP1IIIO = \arg1 arg2 arg3 -> do
      -- solution: arg4[0,2] arg4[0] arg4[1,6] arg4[1] arg4[] p[1,4] x0[1,0] x2[1,3,1,1] x3[1,3,2,2] x[1,1] xs1[1,0] xs4[1,3,2,3] xs[1,2] ys[1,5] yt[1,3,1,1] zs[1,3,1,0] zs[1,3,1] zs[1,3,2,1] zs[1,3,2] zs[1,3]
      -- cost: 3
      (arg4) <- (do
        guard $ arg2 == []
        guard $ arg3 == []
    ...
    spanP1IIOI = \arg1 arg2 arg4 -> do
      -- solution: arg3[0,1] arg3[0] arg3[1,5] arg3[1] arg3[] p[1,4] x0[1,0] x2[1,3,1,2] x3[1,3,2,2] x[1,1] xs1[1,0] xs4[1,3,2,3] xs[1,2] ys[1,3,1,1] ys[1,3,1] ys[1,3,2,0] ys[1,3,2] ys[1,3] yt[1,3,1,0] zs[1,6]
      -- cost: 3
      (arg3) <- (do
        guard $ arg2 == []
        arg3 <- pure []
    ...
    spanP1IIOO = \arg1 arg2 -> do
      -- solution: arg3[0,1] arg3[0] arg3[1,5] arg3[1] arg3[] arg4[0,2] arg4[0] arg4[1,6] arg4[1] arg4[] p[1,4] x0[1,0] x2[1,3,1,2] x3[1,3,2,2] x[1,1] xs1[1,0] xs4[1,3,2,3] xs[1,2] ys[1,3,1,1] ys[1,3,1] ys[1,3,2,0] ys[1,3,2] ys[1,3] yt[1,3,1,0] zs[1,3,1,0] zs[1,3,1] zs[1,3,2,1] zs[1,3,2] zs[1,3]
      -- cost: 4
      (arg3,arg4) <- (do
        guard $ arg2 == []
        arg3 <- pure []
...
reverseDL = rget $ (procedure @'[ 'In, 'In, 'In ] reverseDLIII) :& (procedure @'[ 'In, 'In, 'Out ] reverseDLIIO) :& (procedure @'[ 'In, 'Out, 'In ] reverseDLIOI) :& (procedure @'[ 'Out, 'Out, 'In ] reverseDLOOI) :& RNil
  where
    reverseDLIII = \arg1 arg2 arg3 -> Logic.once $ do
      -- solution: data0[1,3] h0[1,0] h1[1,4] h[1,1] r[1,6] rest[1,5] t[1,0] xs[0,2]
      -- cost: 1
      () <- (do
        xs <- pure arg3
        guard $ arg2 == xs
    ...
    reverseDLIIO = \arg1 arg2 -> do
      -- solution: arg3[0,2] arg3[0] arg3[1,6] arg3[1] arg3[] data0[1,3] h0[1,0] h1[1,4] h[1,1] r[1,2] rest[1,5] t[1,0] xs[0,1]
      -- cost: 2
      (arg3) <- (do
        xs <- pure arg2
        arg3 <- pure xs
    ...
    reverseDLIOI = \arg1 arg3 -> do
      -- solution: arg2[0,1] arg2[0] arg2[1,5] arg2[1] arg2[] data0[1,2] h0[1,0] h1[1,3] h[1,1] r[1,6] rest[1,3] t[1,0] xs[0,2]
      -- cost: 2
      (arg2) <- (do
        xs <- pure arg3
        arg2 <- pure xs
    ...
    reverseDLOOI = \arg3 -> do
      -- solution: arg1[0,0] arg1[0] arg1[1,0] arg1[1] arg1[] arg2[0,1] arg2[0] arg2[1,5] arg2[1] arg2[] data0[1,2] h0[1,1] h1[1,3] h[1,4] r[1,6] rest[1,3] t[1,2] xs[0,2]
      -- cost: 3
      (arg1,arg2) <- (do
        xs <- pure arg3
        arg2 <- pure xs
...
reverse = rget $ (procedure @'[ 'In, 'In ] reverseII) :& (procedure @'[ 'In, 'Out ] reverseIO) :& (procedure @'[ 'Out, 'In ] reverseOI) :& RNil
  where
    ...
    reverseIO = \s -> do
      -- solution: data0[0,1] r[0,0] r[0] r[]
      -- cost: 2
      (r) <- (do
        data0 <- pure []
    ...
    reverseOI = \r -> do
      -- solution: data0[0,0] s[0,0] s[0] s[]
      -- cost: 3
      (s) <- (do
...
all = rget $ (procedure @'[ 'PredMode '[ 'In ], 'In ] allP1II) :& (procedure @'[ 'PredMode '[ 'Out ], 'Out ] allP1OO) :& RNil
  where
    ...
    allP1OO = \arg1 -> do
      -- solution: arg1(1) arg2[0,0] arg2[0] arg2[1,0] arg2[1] arg2[] h[1,1] p(1) p[1,3] t[1,2]
      -- cost: 4
      (arg2) <- (do
        arg2 <- pure []
        pure (arg2)
...
euler1 = rget $ (procedure @'[ 'In ] euler1I) :& (procedure @'[ 'Out ] euler1O) :& RNil
  where
    euler1I = \x -> choose . nub . Logic.observeAll $ do
      -- solution: data0[0,1] data1[0,2] data2[0,3] y[0,5,0,0] y[0,5,0] y[0,5,1,0] y[0,5,1] y[0,5]
      -- cost: 2
      () <- (do
        data0 <- pure 0
        data1 <- pure 999
    ...
    euler1O = choose . nub . Logic.observeAll $ do
      -- solution: data0[0,1] data1[0,2] data2[0,3] x[0,0] x[0] x[] y[0,5,0,0] y[0,5,0] y[0,5,1,0] y[0,5,1] y[0,5]
      -- cost: 3
      (x) <- (do
        data0 <- pure 0
        data1 <- pure 999
...
euler1' = rget $ (procedure @'[ 'In ] euler1'I) :& (procedure @'[ 'Out ] euler1'O) :& RNil
  where
    euler1'I = \carg3 -> Logic.once $ do
      -- solution: euler1[0,1] euler1[0] pred1_1(1) x_0[0,0] x_0[0,1,0,0] x_0[0,1,0]
      -- cost: 5
      () <- (do
    ...
    euler1'O = do
      -- solution: carg3[0,2] carg3[0] carg3[] euler1[0,1] euler1[0] pred1_1(1) x_0[0,0] x_0[0,1,0,0] x_0[0,1,0]
      -- cost: 6
      (carg3) <- (do
        let pred1_1 = procedure @'[ 'Out ] $
              do
...
fib = rget $ (procedure @'[ 'In, 'Out ] fibIO) :& (procedure @'[ 'Out, 'Out ] fibOO) :& RNil
  where
    fibIO = memo $ \arg1 -> choose . Logic.observeAll $ do
      -- solution: arg2[0,1] arg2[0] arg2[1,1] arg2[1] arg2[2,8] arg2[2] arg2[] data0[2,1] fi[2,4] fj[2,5] fk[2,6] i[2,2] j[2,3] k[2,7]
      -- cost: 11
      (arg2) <- (do
        guard $ arg1 == 0
        arg2 <- pure 0
    ...
    fibOO = choose . Logic.observeAll $ do
      -- solution: arg1[0,0] arg1[0] arg1[1,0] arg1[1] arg1[2,7] arg1[2] arg1[] arg2[0,1] arg2[0] arg2[1,1] arg2[1] arg2[2,8] arg2[2] arg2[] data0[2,1] fi[2,4] fj[2,5] fk[2,6] i[2,4] j[2,5] k[2,3]
      -- cost: 12
      (arg1,arg2) <- (do
        arg1 <- pure 0
        arg2 <- pure 0
...
fib' = rget $ (procedure @'[ 'Out ] fib'O) :& RNil
  where
    fib'O = do
      -- solution: carg3[0,1] carg3[0] carg3[] x_0[0,1]
      -- cost: 4
      (carg3) <- (do
...
euler2 = rget $ (procedure @'[ 'In ] euler2I) :& (procedure @'[ 'Out ] euler2O) :& RNil
  where
    euler2I = \carg3 -> Logic.once $ do
      -- solution: data1_1_5[0,3,0,1] fib'[0,1] fib'[0] pred4_1_4(1) x_0[0,2] x_1[0,1,0,0] x_1[0,1,0] x_3[0,0]
      -- cost: 9
      () <- (do
    ...
    euler2O = do
      -- solution: carg3[0,4] carg3[0] carg3[] data1_1_5[0,3,0,1] data1_1_5[0,3] data1_1_5[0] pred4_1_4(1) x_0[0,2] x_1[0,1,0,0] x_1[0,1,0] x_3[0,0]
      -- cost: 10
      (carg3) <- (do
        let pred4_1_4 = procedure @'[ 'Out ] $
              do
...
nontrivialDivisor = rget $ (procedure @'[ 'In, 'In ] nontrivialDivisorII) :& (procedure @'[ 'In, 'Out ] nontrivialDivisorIO) :& RNil
  where
    ...
    nontrivialDivisorIO = \n -> do
      -- solution: d[0,1] d[0] d[] data0[0,2] data1[0,3] n'[0,0]
      -- cost: 5
      (d) <- (do
        data0 <- pure 2
        (OneTuple (n')) <- runProcedure @'[ 'Out, 'In ] succ n
...
primeSlow = rget $ (procedure @'[ 'In ] primeSlowI) :& (procedure @'[ 'Out ] primeSlowO) :& RNil
  where
    ...
    primeSlowO = do
      -- solution: _[0,3] _[0] data0[0,2] n[0,0] n[0] n[]
      -- cost: 6
      (n) <- (do
        data0 <- pure 1
...
{- factor/3
factor arg1 arg2 arg3 :- ((arg2 = p0:ps1, p0 = p, ps1 = ps, if (timesInt p2 p3 pp, p2 = p, p3 = p, (>) pp n) then (f = n) else (if (divMod n p d data0, data0 = 0) then (((f = p); (factor d data1 f, data1 = p4:ps5, p4 = p, ps5 = ps))) else (factor n ps f)), arg1 = n, arg3 = f)).
constraints:
d[0,3,2,0,0]
data0[0,3,2,0]
p2[0,3]
...
factor = rget $ (procedure @'[ 'In, 'In, 'In ] factorIII) :& (procedure @'[ 'In, 'In, 'Out ] factorIIO) :& RNil
  where
    factorIII = \arg1 arg2 arg3 -> Logic.once $ do
      -- solution: d[0,3,2,0,0,0] d[0,3,2,0,0] data0[0,3,2,0,0,1] data0[0,3,2,0] data0[0,3,2] data0[0,3] data0[0] data1[0,3,2,0,1,0,1,1] f[0,5] factor[0,3,2,0,1,0] factor[0,3,2,0,1] factor[0,3,2,0] factor[0,3,2] factor[0,3] factor[0] n[0,4] p0[0,0] p2[0,3,0,1] p2[0,3] p2[0] p3[0,3,0,2] p3[0,3] p3[0] p4[0,3,2,0,1,0,1,2] p[0,1] pp[0,3,0,0] pp[0,3] pp[0] ps1[0,0] ps5[0,3,2,0,1,0,1,3] ps[0,2]
      -- cost: 7
      () <- (do
        n <- pure arg1
        f <- pure arg3
    ...
    factorIIO = \arg1 arg2 -> do
      -- solution: arg3[0,5] arg3[0] arg3[] d[0,3,2,0,0,0] d[0,3,2,0,0] data0[0,3,2,0,0,1] data0[0,3,2,0] data0[0,3,2] data0[0,3] data0[0] data1[0,3,2,0,1,0,1,1] f[0,3,1,0] f[0,3,1] f[0,3,2,0,1,0,0,0] f[0,3,2,0,1,0,0] f[0,3,2,0,1,0,1,0] f[0,3,2,0,1,0,1] f[0,3,2,0,1,0] f[0,3,2,0,1] f[0,3,2,0,2,0] f[0,3,2,0,2] f[0,3,2,0] f[0,3,2] f[0,3] factor[0,3,2,0,1,0] factor[0,3,2,0,1] factor[0,3,2,0] factor[0,3,2] factor[0,3] factor[0] n[0,4] p0[0,0] p2[0,3,0,1] p2[0,3] p2[0] p3[0,3,0,2] p3[0,3] p3[0] p4[0,3,2,0,1,0,1,2] p[0,1] pp[0,3,0,0] pp[0,3] pp[0] ps1[0,0] ps5[0,3,2,0,1,0,1,3] ps[0,2]
      -- cost: 9
      (arg3) <- (do
        n <- pure arg1
        (p0:ps1) <- pure arg2
...
prime = rget $ (procedure @'[ 'Out ] primeO) :& RNil
  where
    primeO = choose . Logic.observeAll $ do
      -- solution: arg1[0,0] arg1[0] arg1[1,6] arg1[1] arg1[] curry1[1,4,0,0] curry1[1,4,0] d[1,5,0,0] d[1,5] d[1] data0[1,2] p[1,0] pred1(1) prime[1,4] prime[1] primes[1,3]
      -- cost: 11
      (arg1) <- (do
        arg1 <- pure 2
        pure (arg1)
...
primeFactor = rget $ (procedure @'[ 'In, 'In ] primeFactorII) :& (procedure @'[ 'In, 'Out ] primeFactorIO) :& RNil
  where
    primeFactorII = \n carg3 -> Logic.once $ do
      -- solution: pred1_1(1) prime[0,1] prime[0] x_0[0,0] x_0[0,1,0,0] x_0[0,1,0]
      -- cost: 5
      () <- (do
        let pred1_1 = procedure @'[ 'Out ] $
              do
    ...
    primeFactorIO = \n -> do
      -- solution: carg3[0,2] carg3[0] carg3[] pred1_1(1) prime[0,1] prime[0] x_0[0,0] x_0[0,1,0,0] x_0[0,1,0]
      -- cost: 6
      (carg3) <- (do
        let pred1_1 = procedure @'[ 'Out ] $
              do
...
euler3 = rget $ (procedure @'[ 'In, 'In ] euler3II) :& (procedure @'[ 'In, 'Out ] euler3IO) :& RNil
  where
    euler3II = \n carg3 -> Logic.once $ do
      -- solution: pred1_1(1) primeFactor[0,1] primeFactor[0] x_0[0,0] x_0[0,1,0,0] x_0[0,1,0]
      -- cost: 5
      () <- (do
        let pred1_1 = procedure @'[ 'Out ] $
              do
    ...
    euler3IO = \n -> do
      -- solution: carg3[0,2] carg3[0] carg3[] pred1_1(1) x_0[0,0] x_0[0,1,0,0] x_0[0,1,0]
      -- cost: 6
      (carg3) <- (do
        let pred1_1 = procedure @'[ 'Out ] $
              do
...
euler4 = rget $ (procedure @'[ 'In ] euler4I) :& (procedure @'[ 'Out ] euler4O) :& RNil
  where
    euler4I = \n -> Logic.once $ do
      -- solution: data0[0,1] data1[0,2] data2[0,3] data3[0,5] data4[0,6] data5[0,7] s0[0,11] s1[0,12] s[0,9] x[0,0] y[0,8]
      -- cost: 8
      () <- (do
        data0 <- pure 10
        data3 <- pure 10
    ...
    euler4O = do
      -- solution: data0[0,1] data1[0,2] data2[0,3] data3[0,5] data4[0,6] data5[0,7] n[0,8] n[0] n[] s0[0,11] s1[0,12] s[0,9] x[0,0] y[0,4]
      -- cost: 9
      (n) <- (do
        data0 <- pure 10
        data3 <- pure 10
...
euler4' = rget $ (procedure @'[ 'In ] euler4'I) :& (procedure @'[ 'Out ] euler4'O) :& RNil
  where
    euler4'I = \carg3 -> Logic.once $ do
      -- solution: euler4[0,1] euler4[0] pred1_1(1) x_0[0,0] x_0[0,1,0,0] x_0[0,1,0]
      -- cost: 5
      () <- (do
        let pred1_1 = procedure @'[ 'Out ] $
              do
    ...
    euler4'O = do
      -- solution: carg3[0,2] carg3[0] carg3[] euler4[0,1] euler4[0] pred1_1(1) x_0[0,0] x_0[0,1,0,0] x_0[0,1,0]
      -- cost: 6
      (carg3) <- (do
        let pred1_1 = procedure @'[ 'Out ] $
              do
...
euler5 = rget $ (procedure @'[ 'In ] euler5I) :& (procedure @'[ 'Out ] euler5O) :& RNil
  where
    euler5I = \n -> Logic.once $ do
      -- solution: data0[0,2] data2[0,4] data3[0,5] data4[0,6] multiple[0,7] multiple[0]
      -- cost: 4
      () <- (do
        data0 <- pure 0
        data2 <- pure 1
    ...
    euler5O = do
      -- solution: data0[0,2] data2[0,4] data3[0,5] data4[0,6] n[0,0] n[0] n[]
      -- cost: 5
      (n) <- (do
        data0 <- pure 0
        data2 <- pure 1
