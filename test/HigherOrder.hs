...
map = rget $ (procedure @'[ 'PredMode '[ 'In, 'In ], 'In, 'In ] mapP2IIII) :& (procedure @'[ 'PredMode '[ 'In, 'Out ], 'In, 'Out ] mapP2IOIO) :& (procedure @'[ 'PredMode '[ 'Out, 'In ], 'Out, 'In ] mapP2OIOI) :& (procedure @'[ 'PredMode '[ 'Out, 'Out ], 'Out, 'Out ] mapP2OOOO) :& RNil
  where
    ...
    mapP2IOIO = \arg1 arg2 -> do
      -- solution: arg1(2) arg3[0,1] arg3[0] arg3[1,1] arg3[1] arg3[] p(2) p[1,4] x[1,0] xs[1,0] y[1,2] ys[1,3]
      -- cost: 4
      (arg3) <- (do
        guard $ arg2 == []
        arg3 <- pure []
    ...
    mapP2OIOI = \arg1 arg3 -> do
      -- solution: arg1(1) arg2[0,0] arg2[0] arg2[1,0] arg2[1] arg2[] p(1) p[1,4] x[1,2] xs[1,3] y[1,1] ys[1,1]
      -- cost: 4
      (arg2) <- (do
        arg2 <- pure []
        guard $ arg3 == []
    ...
    mapP2OOOO = \arg1 -> do
      -- solution: arg1(1) arg1(2) arg2[0,0] arg2[0] arg2[1,0] arg2[1] arg2[] arg3[0,1] arg3[0] arg3[1,1] arg3[1] arg3[] p(1) p(2) p[1,4] x[1,2] xs[1,3] y[1,2] ys[1,3]
      -- cost: 6
      (arg2,arg3) <- (do
        arg2 <- pure []
        arg3 <- pure []
...
succs = rget $ (procedure @'[ 'In, 'In ] succsII) :& (procedure @'[ 'In, 'Out ] succsIO) :& (procedure @'[ 'Out, 'In ] succsOI) :& RNil
  where
    ...
    succsIO = \xs -> do
      -- solution: curry2[0,1,0,0] curry2[0,1,0] pred0(2) succ[0,1] succ[0] ys[0,0] ys[0] ys[]
      -- cost: 4
      (ys) <- (do
    ...
    succsOI = \ys -> do
      -- solution: curry1[0,1,0,0] curry1[0,1,0] pred0(1) succ[0,1] succ[0] xs[0,0] xs[0] xs[]
      -- cost: 4
      (xs) <- (do
...
filter = rget $ (procedure @'[ 'PredMode '[ 'In ], 'In, 'In ] filterP1III) :& (procedure @'[ 'PredMode '[ 'In ], 'In, 'Out ] filterP1IIO) :& RNil
  where
    filterP1III = \arg1 arg2 arg3 -> Logic.once $ do
      -- solution: h0[1,0] h1[1,2,1,1] h[1,1] p[1,3] t'[1,2,1,1] t[1,0] ts[1,4]
      -- cost: 3
      () <- (do
        guard $ arg2 == []
        guard $ arg3 == []
    ...
    filterP1IIO = \arg1 arg2 -> do
      -- solution: arg3[0,1] arg3[0] arg3[1,4] arg3[1] arg3[] h0[1,0] h1[1,2,1,2] h[1,1] p[1,3] t'[1,2,1,0] t[1,0] ts[1,2,1,1] ts[1,2,1] ts[1,2,2,0] ts[1,2,2] ts[1,2]
      -- cost: 5
      (arg3) <- (do
        guard $ arg2 == []
        arg3 <- pure []
...
foldl = rget $ (procedure @'[ 'PredMode '[ 'In, 'In, 'Out ], 'In, 'In, 'In ] foldlP3IIOIII) :& (procedure @'[ 'PredMode '[ 'In, 'In, 'Out ], 'In, 'In, 'Out ] foldlP3IIOIIO) :& (procedure @'[ 'PredMode '[ 'In, 'Out, 'In ], 'In, 'Out, 'In ] foldlP3IOIIOI) :& (procedure @'[ 'PredMode '[ 'In, 'Out, 'Out ], 'In, 'In, 'In ] foldlP3IOOIII) :& (procedure @'[ 'PredMode '[ 'In, 'Out, 'Out ], 'In, 'In, 'Out ] foldlP3IOOIIO) :& (procedure @'[ 'PredMode '[ 'Out, 'In, 'Out ], 'Out, 'In, 'In ] foldlP3OIOOII) :& (procedure @'[ 'PredMode '[ 'Out, 'In, 'Out ], 'Out, 'In, 'Out ] foldlP3OIOOIO) :& (procedure @'[ 'PredMode '[ 'Out, 'Out, 'In ], 'Out, 'Out, 'In ] foldlP3OOIOOI) :& (procedure @'[ 'PredMode '[ 'Out, 'Out, 'Out ], 'Out, 'In, 'In ] foldlP3OOOOII) :& (procedure @'[ 'PredMode '[ 'Out, 'Out, 'Out ], 'Out, 'In, 'Out ] foldlP3OOOOIO) :& RNil
  where
    foldlP3IIOIII = \arg1 arg2 arg3 arg4 -> Logic.once $ do
      -- solution: a''[1,5] a'[1,1] a[0,1] a[1,4] arg1(3) h[1,0] p(3) p[1,3] t[1,0]
      -- cost: 3
      () <- (do
        a <- pure arg3
        guard $ arg4 == a
    ...
    foldlP3IIOIIO = \arg1 arg2 arg3 -> do
      -- solution: a''[1,2] a'[1,1] a[0,1] a[1,4] arg1(3) arg4[0,2] arg4[0] arg4[1,5] arg4[1] arg4[] h[1,0] p(3) p[1,3] t[1,0]
      -- cost: 4
      (arg4) <- (do
        a <- pure arg3
        arg4 <- pure a
    ...
    foldlP3IOIIOI = \arg1 arg2 arg4 -> do
      -- solution: a''[1,5] a'[1,2] a[0,2] a[1,1] arg1(2) arg3[0,1] arg3[0] arg3[1,4] arg3[1] arg3[] h[1,0] p(2) p[1,3] t[1,0]
      -- cost: 4
      (arg3) <- (do
        a <- pure arg4
        arg3 <- pure a
    ...
    foldlP3IOOIII = \arg1 arg2 arg3 arg4 -> Logic.once $ do
      -- solution: a''[1,5] a'[1,1] a[0,2] a[1,1] arg1(2) arg1(3) h[1,0] p(2) p(3) p[1,3] t[1,0]
      -- cost: 4
      () <- (do
        a <- pure arg4
        guard $ arg3 == a
    ...
    foldlP3IOOIIO = \arg1 arg2 arg3 -> do
      -- solution: a''[1,2] a'[1,1] a[0,1] a[1,1] arg1(2) arg1(3) arg4[0,2] arg4[0] arg4[1,5] arg4[1] arg4[] h[1,0] p(2) p(3) p[1,3] t[1,0]
      -- cost: 5
      (arg4) <- (do
        a <- pure arg3
        arg4 <- pure a
    ...
    foldlP3OIOOII = \arg1 arg3 arg4 -> do
      -- solution: a''[1,5] a'[1,1] a[0,2] a[1,4] arg1(1) arg1(3) arg2[0,0] arg2[0] arg2[1,0] arg2[1] arg2[] h[1,1] p(1) p(3) p[1,3] t[1,2]
      -- cost: 5
      (arg2) <- (do
        a <- pure arg4
        guard $ arg3 == a
    ...
    foldlP3OIOOIO = \arg1 arg3 -> do
      -- solution: a''[1,2] a'[1,1] a[0,1] a[1,4] arg1(1) arg1(3) arg2[0,0] arg2[0] arg2[1,0] arg2[1] arg2[] arg4[0,2] arg4[0] arg4[1,5] arg4[1] arg4[] h[1,1] p(1) p(3) p[1,3] t[1,2]
      -- cost: 6
      (arg2,arg4) <- (do
        a <- pure arg3
        arg4 <- pure a
    ...
    foldlP3OOIOOI = \arg1 arg4 -> do
      -- solution: a''[1,5] a'[1,2] a[0,2] a[1,1] arg1(1) arg1(2) arg2[0,0] arg2[0] arg2[1,0] arg2[1] arg2[] arg3[0,1] arg3[0] arg3[1,4] arg3[1] arg3[] h[1,1] p(1) p(2) p[1,3] t[1,2]
      -- cost: 6
      (arg2,arg3) <- (do
        a <- pure arg4
        arg3 <- pure a
    ...
    foldlP3OOOOII = \arg1 arg3 arg4 -> do
      -- solution: a''[1,5] a'[1,1] a[0,2] a[1,1] arg1(1) arg1(2) arg1(3) arg2[0,0] arg2[0] arg2[1,0] arg2[1] arg2[] h[1,1] p(1) p(2) p(3) p[1,3] t[1,2]
      -- cost: 6
      (arg2) <- (do
        a <- pure arg4
        guard $ arg3 == a
    ...
    foldlP3OOOOIO = \arg1 arg3 -> do
      -- solution: a''[1,2] a'[1,1] a[0,1] a[1,1] arg1(1) arg1(2) arg1(3) arg2[0,0] arg2[0] arg2[1,0] arg2[1] arg2[] arg4[0,2] arg4[0] arg4[1,5] arg4[1] arg4[] h[1,1] p(1) p(2) p(3) p[1,3] t[1,2]
      -- cost: 7
      (arg2,arg4) <- (do
        a <- pure arg3
        arg4 <- pure a
...
sum = rget $ (procedure @'[ 'In, 'In, 'In ] sumIII) :& (procedure @'[ 'In, 'In, 'Out ] sumIIO) :& (procedure @'[ 'In, 'Out, 'In ] sumIOI) :& RNil
  where
    sumIII = \xs z r -> Logic.once $ do
      -- solution: curry3[0,1,0,0] curry3[0,1,0] plus[0,1] plus[0] pred0(3)
      -- cost: 3
      () <- (do
    ...
    sumIIO = \xs z -> do
      -- solution: curry3[0,1,0,0] curry3[0,1,0] pred0(3) r[0,0] r[0] r[]
      -- cost: 4
      (r) <- (do
        let pred0 = procedure @'[ 'In, 'In, 'Out ] $
              \curry1 curry2 -> do
    ...
    sumIOI = \xs r -> do
      -- solution: curry2[0,1,0,0] curry2[0,1,0] pred0(2) z[0,0] z[0] z[]
      -- cost: 4
      (z) <- (do
...
split = rget $ (procedure @'[ 'In, 'Out, 'In ] splitIOI) :& (procedure @'[ 'Out, 'In, 'In ] splitOII) :& (procedure @'[ 'Out, 'In, 'Out ] splitOIO) :& RNil
  where
    splitIOI = \xs r -> do
      -- solution: a[0,1,0,0] a[0,1,0] pred0(2) z[0,0] z[0] z[]
      -- cost: 2
      (z) <- (do
        let pred0 = procedure @'[ 'In, 'Out, 'In ] $
              \x a' -> do
    ...
    splitOII = \z r -> do
      -- solution: a'[0,1,0,0] a'[0,1,0] pred0(1) pred0(3) x[0,1,0,0] x[0,1,0] xs[0,0] xs[0] xs[]
      -- cost: 2
      (xs) <- (do
    ...
    splitOIO = \z -> do
      -- solution: a'[0,1,0,0] a'[0,1,0] pred0(1) pred0(3) r[0,0] r[0] r[] x[0,1,0,0] x[0,1,0] xs[0,0] xs[0] xs[]
      -- cost: 3
      (r,xs) <- (do
        let pred0 = procedure @'[ 'Out, 'In, 'Out ] $
              \a -> do
...
splitr = rget $ (procedure @'[ 'In, 'In, 'In ] splitrIII) :& (procedure @'[ 'In, 'In, 'Out ] splitrIIO) :& (procedure @'[ 'Out, 'Out, 'In ] splitrOOI) :& RNil
  where
    splitrIII = \xs z r -> Logic.once $ do
      -- solution: a'[0,1,0,0] a'[0,1,0] pred0(3)
      -- cost: 1
      () <- (do
        let pred0 = procedure @'[ 'In, 'In, 'Out ] $
              \x a -> do
    ...
    splitrIIO = \xs z -> do
      -- solution: a'[0,1,0,0] a'[0,1,0] pred0(3) r[0,0] r[0] r[]
      -- cost: 2
      (r) <- (do
        let pred0 = procedure @'[ 'In, 'In, 'Out ] $
              \x a -> do
    ...
    splitrOOI = \r -> do
      -- solution: a[0,1,0,0] a[0,1,0] pred0(1) pred0(2) x[0,1,0,0] x[0,1,0] xs[0,0] xs[0] xs[] z[0,0] z[0] z[]
      -- cost: 3
      (xs,z) <- (do
...
closure = rget $ (procedure @'[ 'PredMode '[ 'In, 'Out ], 'In, 'In ] closureP2IOII) :& (procedure @'[ 'PredMode '[ 'In, 'Out ], 'In, 'Out ] closureP2IOIO) :& (procedure @'[ 'PredMode '[ 'Out, 'In ], 'Out, 'In ] closureP2OIOI) :& (procedure @'[ 'PredMode '[ 'Out, 'Out ], 'In, 'In ] closureP2OOII) :& (procedure @'[ 'PredMode '[ 'Out, 'Out ], 'In, 'Out ] closureP2OOIO) :& RNil
  where
    closureP2IOII = \arg1 arg2 arg3 -> Logic.once $ do
      -- solution: arg1(2) p(2) p[0,1] p[1,2] x[0,2] x[1,3] y[0,0] y[1,4] z[1,0]
      -- cost: 5
      () <- (do
        p <- pure arg1
        x <- pure arg2
    ...
    closureP2IOIO = \arg1 arg2 -> do
      -- solution: arg1(2) arg3[0,3] arg3[0] arg3[1,4] arg3[1] arg3[] p(2) p[0,1] p[1,2] x[0,2] x[1,3] y[0,0] y[1,1] z[1,0]
      -- cost: 6
      (arg3) <- (do
        p <- pure arg1
        x <- pure arg2
    ...
    closureP2OIOI = \arg1 arg3 -> do
      -- solution: arg1(1) arg2[0,2] arg2[0] arg2[1,3] arg2[1] arg2[] p(1) p[0,1] p[1,2] x[0,0] x[1,0] y[0,3] y[1,4] z[1,1]
      -- cost: 6
      (arg2) <- (do
        p <- pure arg1
        y <- pure arg3
    ...
    closureP2OOII = \arg1 arg2 arg3 -> Logic.once $ do
      -- solution: arg1(1) arg1(2) p(1) p(2) p[0,1] p[1,2] x[0,0] x[1,0] y[0,0] y[1,4] z[1,0]
      -- cost: 7
      () <- (do
        p <- pure arg1
        (x,y) <- runProcedure @'[ 'Out, 'Out ] p 
    ...
    closureP2OOIO = \arg1 arg2 -> do
      -- solution: arg1(1) arg1(2) arg3[0,3] arg3[0] arg3[1,4] arg3[1] arg3[] p(1) p(2) p[0,1] p[1,2] x[0,0] x[1,0] y[0,0] y[1,1] z[1,0]
      -- cost: 8
      (arg3) <- (do
        p <- pure arg1
        (x,y) <- runProcedure @'[ 'Out, 'Out ] p 
...
smaller = rget $ (procedure @'[ 'In, 'In ] smallerII) :& (procedure @'[ 'In, 'Out ] smallerIO) :& (procedure @'[ 'Out, 'In ] smallerOI) :& (procedure @'[ 'Out, 'Out ] smallerOO) :& RNil
  where
    ...
    smallerIO = \arg1 -> do
      -- solution: arg2[0,1] arg2[0] arg2[1,1] arg2[1] arg2[]
      -- cost: 0
      (arg2) <- (do
        guard $ arg1 == 1
        arg2 <- pure 2
    ...
    smallerOO = do
      -- solution: arg1[0,0] arg1[0] arg1[1,0] arg1[1] arg1[] arg2[0,1] arg2[0] arg2[1,1] arg2[1] arg2[]
      -- cost: 0
      (arg1,arg2) <- (do
        arg1 <- pure 1
        arg2 <- pure 2
...
smallerTransitive = rget $ (procedure @'[ 'In, 'In ] smallerTransitiveII) :& (procedure @'[ 'In, 'Out ] smallerTransitiveIO) :& (procedure @'[ 'Out, 'In ] smallerTransitiveOI) :& RNil
  where
    smallerTransitiveII = \x y -> Logic.once $ do
      -- solution: curry2[0,1,0,0] curry2[0,1,0] pred0(2) smaller[0,1] smaller[0]
      -- cost: 3
      () <- (do
        let pred0 = procedure @'[ 'In, 'Out ] $
              \curry1 -> do
    ...
    smallerTransitiveIO = \x -> do
      -- solution: curry2[0,1,0,0] curry2[0,1,0] pred0(2) y[0,0] y[0] y[]
      -- cost: 4
      (y) <- (do
        let pred0 = procedure @'[ 'In, 'Out ] $
              \curry1 -> do
    ...
    smallerTransitiveOI = \y -> do
      -- solution: curry1[0,1,0,0] curry1[0,1,0] pred0(1) smaller[0,1] smaller[0] x[0,0] x[0] x[]
      -- cost: 4
      (x) <- (do
        let pred0 = procedure @'[ 'Out, 'In ] $
              \curry2 -> do
...
compose = rget $ (procedure @'[ 'PredMode '[ 'In, 'In ], 'PredMode '[ 'In, 'Out ], 'In, 'In ] composeP2IIP2IOII) :& (procedure @'[ 'PredMode '[ 'In, 'In ], 'PredMode '[ 'Out, 'Out ], 'Out, 'In ] composeP2IIP2OOOI) :& (procedure @'[ 'PredMode '[ 'In, 'Out ], 'PredMode '[ 'In, 'Out ], 'In, 'Out ] composeP2IOP2IOIO) :& (procedure @'[ 'PredMode '[ 'In, 'Out ], 'PredMode '[ 'Out, 'Out ], 'Out, 'Out ] composeP2IOP2OOOO) :& (procedure @'[ 'PredMode '[ 'Out, 'In ], 'PredMode '[ 'In, 'In ], 'In, 'In ] composeP2OIP2IIII) :& (procedure @'[ 'PredMode '[ 'Out, 'In ], 'PredMode '[ 'Out, 'In ], 'Out, 'In ] composeP2OIP2OIOI) :& (procedure @'[ 'PredMode '[ 'Out, 'Out ], 'PredMode '[ 'In, 'In ], 'In, 'Out ] composeP2OOP2IIIO) :& (procedure @'[ 'PredMode '[ 'Out, 'Out ], 'PredMode '[ 'Out, 'In ], 'Out, 'Out ] composeP2OOP2OIOO) :& RNil
  where
    ...
    composeP2IIP2OOOI = \f g z -> do
      -- solution: a[0,0] a[0] a[] b[0,0] g(1) g(2)
      -- cost: 4
      (a) <- (do
        (a,b) <- runProcedure g 
        () <- runProcedure f b z
    ...
    composeP2IOP2IOIO = \f g a -> do
      -- solution: b[0,0] f(2) g(2) z[0,1] z[0] z[]
      -- cost: 4
      (z) <- (do
        (OneTuple (b)) <- runProcedure g a
    ...
    composeP2IOP2OOOO = \f g -> do
      -- solution: a[0,0] a[0] a[] b[0,0] f(2) g(1) g(2) z[0,1] z[0] z[]
      -- cost: 5
      (a,z) <- (do
        (a,b) <- runProcedure g 
        (OneTuple (z)) <- runProcedure f b
    ...
    composeP2OIP2OIOI = \f g z -> do
      -- solution: a[0,0] a[0] a[] b[0,1] f(1) g(1)
      -- cost: 4
      (a) <- (do
        (OneTuple (b)) <- runProcedure f z
    ...
    composeP2OOP2IIIO = \f g a -> do
      -- solution: b[0,1] f(1) f(2) z[0,1] z[0] z[]
      -- cost: 4
      (z) <- (do
        (b,z) <- runProcedure f 
        () <- runProcedure g a b
    ...
    composeP2OOP2OIOO = \f g -> do
      -- solution: a[0,0] a[0] a[] b[0,1] f(1) f(2) g(1) z[0,1] z[0] z[]
      -- cost: 5
      (a,z) <- (do
        (b,z) <- runProcedure f 
        (OneTuple (a)) <- runProcedure g b
...
composeTest = rget $ (procedure @'[ 'In, 'In ] composeTestII) :& (procedure @'[ 'In, 'Out ] composeTestIO) :& (procedure @'[ 'Out, 'In ] composeTestOI) :& RNil
  where
    composeTestII = \a z -> Logic.once $ do
      -- solution: curry1[0,1,0,0] curry1[0,1,0] data0[0,1,0,1] data2[0,2,0,1] pred1(1) times[0,1] times[0]
      -- cost: 4
      () <- (do
    ...
    composeTestIO = \a -> do
      -- solution: curry2[0,1,0,0] curry2[0,1,0] curry2[0,2,0,0] curry2[0,2,0] data0[0,1,0,1] data2[0,2,0,1] plus[0,2] plus[0] pred1(2) pred3(2) times[0,1] times[0] z[0,0] z[0] z[]
      -- cost: 6
      (z) <- (do
    ...
    composeTestOI = \z -> do
      -- solution: a[0,0] a[0] a[] curry1[0,1,0,0] curry1[0,1,0] curry1[0,2,0,0] curry1[0,2,0] data0[0,1,0,1] data2[0,2,0,1] plus[0,2] plus[0] pred1(1) pred3(1) times[0,1] times[0]
      -- cost: 6
      (a) <- (do
        let pred1 = procedure @'[ 'Out, 'In ] $
              \curry2 -> do
...
inlineTest = rget $ (procedure @'[ 'In ] inlineTestI) :& (procedure @'[ 'Out ] inlineTestO) :& RNil
  where
    ...
    inlineTestO = do
      -- solution: data0[0,1] y[0,0] y[0] y[]
      -- cost: 0
      (y) <- (do
        data0 <- pure 7
        y <- pure data0
