...
classify_ii arg1 arg2 = do
  -- solution: data0[0,2,0,1,0,0,0] data0[0,2,0,1,0,0] h[0,2,0,2,0,0,0,0] h[0,2,0,2,0,0,0] h[0,2,0,2,0,0] r[0,1] xs[0,0] ~arg1[0,0] ~arg1[0] ~arg1[] ~arg2[0,1] ~arg2[0] ~arg2[] ~data0[0,2,0,1,0,1,0] ~data0[0,2,0,1,0,1] ~h[0,2,0,2,0,1,0,0] ~h[0,2,0,2,0,1,0] ~h[0,2,0,2,0,1] ~r[0,2,0,1,0,0,0] ~r[0,2,0,1,0,0] ~r[0,2,0,1,0] ~r[0,2,0,1] ~r[0,2,0,2,0,1,0,0] ~r[0,2,0,2,0,1,0] ~r[0,2,0,2,0,1] ~r[0,2,0,2,0,2,0,0] ~r[0,2,0,2,0,2,0] ~r[0,2,0,2,0,2] ~r[0,2,0,2,0] ~r[0,2,0,2] ~r[0,2,0] ~r[0,2] ~xs[0,2,0,0,0,0] ~xs[0,2,0,0,0] ~xs[0,2,0,2,0,0,0,0] ~xs[0,2,0,2,0,0,0] ~xs[0,2,0,2,0] ~xs[0,2,0,2] ~xs[0,2,0] ~xs[0,2]
  () <- (do
    xs <- pure arg1
    r <- pure arg2
    () <- (do
...
--classify_ii arg1 arg2 = do
--  -- solution: data0[0,2,0,1,0,0,0] data0[0,2,0,1,0,0] h[0,2,0,2,0,1,0,0] h[0,2,0,2,0,1,0] h[0,2,0,2,0,1] r[0,1] xs[0,0] ~arg1[0,0] ~arg1[0] ~arg1[] ~arg2[0,1] ~arg2[0] ~arg2[] ~data0[0,2,0,1,0,1,0] ~data0[0,2,0,1,0,1] ~h[0,2,0,2,0,0,0,0] ~h[0,2,0,2,0,0,0] ~h[0,2,0,2,0,0] ~r[0,2,0,1,0,0,0] ~r[0,2,0,1,0,0] ~r[0,2,0,1,0] ~r[0,2,0,1] ~r[0,2,0,2,0,1,0,0] ~r[0,2,0,2,0,1,0] ~r[0,2,0,2,0,1] ~r[0,2,0,2,0,2,0,0] ~r[0,2,0,2,0,2,0] ~r[0,2,0,2,0,2] ~r[0,2,0,2,0] ~r[0,2,0,2] ~r[0,2,0] ~r[0,2] ~xs[0,2,0,0,0,0] ~xs[0,2,0,0,0] ~xs[0,2,0,2,0,0,0,0] ~xs[0,2,0,2,0,0,0] ~xs[0,2,0,2,0] ~xs[0,2,0,2] ~xs[0,2,0] ~xs[0,2]
--  () <- (do
--    xs <- pure arg1
--    r <- pure arg2
--    () <- (do
...
--classify_ii arg1 arg2 = do
--  -- solution: data0[0,2,0,1,0,1,0] data0[0,2,0,1,0,1] h[0,2,0,2,0,0,0,0] h[0,2,0,2,0,0,0] h[0,2,0,2,0,0] r[0,1] xs[0,0] ~arg1[0,0] ~arg1[0] ~arg1[] ~arg2[0,1] ~arg2[0] ~arg2[] ~data0[0,2,0,1,0,0,0] ~data0[0,2,0,1,0,0] ~h[0,2,0,2,0,1,0,0] ~h[0,2,0,2,0,1,0] ~h[0,2,0,2,0,1] ~r[0,2,0,1,0,0,0] ~r[0,2,0,1,0,0] ~r[0,2,0,1,0] ~r[0,2,0,1] ~r[0,2,0,2,0,1,0,0] ~r[0,2,0,2,0,1,0] ~r[0,2,0,2,0,1] ~r[0,2,0,2,0,2,0,0] ~r[0,2,0,2,0,2,0] ~r[0,2,0,2,0,2] ~r[0,2,0,2,0] ~r[0,2,0,2] ~r[0,2,0] ~r[0,2] ~xs[0,2,0,0,0,0] ~xs[0,2,0,0,0] ~xs[0,2,0,2,0,0,0,0] ~xs[0,2,0,2,0,0,0] ~xs[0,2,0,2,0] ~xs[0,2,0,2] ~xs[0,2,0] ~xs[0,2]
--  () <- (do
--    xs <- pure arg1
--    r <- pure arg2
--    () <- (do
...
--classify_ii arg1 arg2 = do
--  -- solution: data0[0,2,0,1,0,1,0] data0[0,2,0,1,0,1] h[0,2,0,2,0,1,0,0] h[0,2,0,2,0,1,0] h[0,2,0,2,0,1] r[0,1] xs[0,0] ~arg1[0,0] ~arg1[0] ~arg1[] ~arg2[0,1] ~arg2[0] ~arg2[] ~data0[0,2,0,1,0,0,0] ~data0[0,2,0,1,0,0] ~h[0,2,0,2,0,0,0,0] ~h[0,2,0,2,0,0,0] ~h[0,2,0,2,0,0] ~r[0,2,0,1,0,0,0] ~r[0,2,0,1,0,0] ~r[0,2,0,1,0] ~r[0,2,0,1] ~r[0,2,0,2,0,1,0,0] ~r[0,2,0,2,0,1,0] ~r[0,2,0,2,0,1] ~r[0,2,0,2,0,2,0,0] ~r[0,2,0,2,0,2,0] ~r[0,2,0,2,0,2] ~r[0,2,0,2,0] ~r[0,2,0,2] ~r[0,2,0] ~r[0,2] ~xs[0,2,0,0,0,0] ~xs[0,2,0,0,0] ~xs[0,2,0,2,0,0,0,0] ~xs[0,2,0,2,0,0,0] ~xs[0,2,0,2,0] ~xs[0,2,0,2] ~xs[0,2,0] ~xs[0,2]
--  () <- (do
--    xs <- pure arg1
--    r <- pure arg2
--    () <- (do
...
classify_io arg1 = do
  -- solution: arg2[0,1] arg2[0] arg2[] data0[0,2,0,1,0,1,0] data0[0,2,0,1,0,1] h[0,2,0,2,0,0,0,0] h[0,2,0,2,0,0,0] h[0,2,0,2,0,0] r[0,2,0,1,0,0,0] r[0,2,0,1,0,0] r[0,2,0,1,0] r[0,2,0,1] r[0,2,0,2,0,1,0,0] r[0,2,0,2,0,1,0] r[0,2,0,2,0,1] r[0,2,0,2,0,2,0,0] r[0,2,0,2,0,2,0] r[0,2,0,2,0,2] r[0,2,0,2,0] r[0,2,0,2] r[0,2,0] r[0,2] xs[0,0] ~arg1[0,0] ~arg1[0] ~arg1[] ~data0[0,2,0,1,0,0,0] ~data0[0,2,0,1,0,0] ~h[0,2,0,2,0,1,0,0] ~h[0,2,0,2,0,1,0] ~h[0,2,0,2,0,1] ~r[0,1] ~xs[0,2,0,0,0,0] ~xs[0,2,0,0,0] ~xs[0,2,0,2,0,0,0,0] ~xs[0,2,0,2,0,0,0] ~xs[0,2,0,2,0] ~xs[0,2,0,2] ~xs[0,2,0] ~xs[0,2]
  (arg2) <- (do
    xs <- pure arg1
    (r) <- (do
      (r) <- ifte ((do
